...
export const CLIENT_STEPS: TourStep[] = [
  ...
  },
  {
    ...
    target: "tour-sidebar",
    title: "Ваши проекты",
    body: "Слева — лента и список проектов. Проекты создаёт агентство; вы работаете с задачами внутри них.",
    placement: "right",
    route: "home",
  },
  {
  ...
  },
  {
    ...
    body: "Откройте проект агентства, поставьте задачу и напишите в чат — команда подхватит.",
  },
];
