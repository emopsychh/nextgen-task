...
export const AGENCY_STEPS: TourStep[] = [
  ...
  },
  {
    ...
    body: "В боковой панели — обзор, проекты, отчёты и бэклог выбранного клиента. Заявки клиента на согласование видны в бэклоге.",
    placement: "right",
  ...
  },
  {
    ...
    body: "Привяжите клиента, задайте пакет часов на карточке, создайте проект и задачу.",
  },
];
...
export const CLIENT_STEPS: TourStep[] = [
  ...
  },
  {
    ...
    body: "Слева — обзор, проекты, заявки на согласование и отчёты. Проекты создаёт агентство; вы отправляете задачи на согласование.",
    placement: "right",
    route: "home",
  },
  {
  ...
  },
  {
    ...
    body: "Здесь пакет часов, проекты в работе, то что ждёт вашего ответа, и недавно завершённые задачи.",
    placement: "top",
    route: "home",
  },
  {
    ...
    body: "Вы описываете задачу на согласование. «Начать» и «Завершить» нажимает команда, когда заявка уже в проекте.",
    placement: "right",
    route: "home",
  },
  {
    ...
    body: "Откройте «На согласование» и отправьте задачу команде. Она попадёт в проект, когда агентство добавит её в работу.",
  },
];
